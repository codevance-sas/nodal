        ...
        <Card className={cn(
          ...
          <CardContent className="flex justify-center items-center min-h-[400px]">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-body text-muted-foreground">Loading charts and analysis...</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto animate-in fade-in-0 slide-in-from-bottom-4 duration-500">
        <Alert className={cn(
          ...
          <AlertDescription className="text-system-red/90 font-medium">
            <span className="font-semibold">Analysis Error:</span> {errors.hydraulics}
          </AlertDescription>
        </Alert>
      </div>
    );
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-subheadline text-muted-foreground leading-relaxed">
                Interactive charts and comprehensive analysis of IPR/VLP intersection and operating point
              </CardDescription>
            </div>
          </div>
        </CardHeader>
            ...
            <div className="space-y-4">
              ...
              <Alert className={cn(
                ...
                <AlertDescription className="text-system-orange/90 font-medium space-y-2">
                  <div className="font-semibold">
                    Complete all previous sections to generate nodal analysis results
                  </div>
                  {!completeness.hydraulics && (
                    <div className="text-sm">
                      Please calculate wellbore hydraulics to view the nodal analysis charts and operating point.
                    </div>
                  )}
                </AlertDescription>
              </Alert>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className={cn(
                  ...
                  completeness.ipr ? 'border-system-green/30 bg-system-green/5' : 'border-border/30'
                )}>
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      <div className={cn(
                        'h-3 w-3 rounded-full',
                        completeness.ipr ? 'bg-system-green' : 'bg-muted-foreground/30'
                      )} />
                      <span className={cn(
                        'text-sm font-medium',
                        completeness.ipr ? 'text-system-green' : 'text-muted-foreground'
                      )}>
                        IPR Analysis
                      </span>
                    </div>
                ...
                <Card className={cn(
                  'transition-all duration-200',
                  completeness.pvt ? 'border-system-green/30 bg-system-green/5' : 'border-border/30'
                )}>
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      <div className={cn(
                        'h-3 w-3 rounded-full',
                        completeness.pvt ? 'bg-system-green' : 'bg-muted-foreground/30'
                      )} />
                      <span className={cn(
                        'text-sm font-medium',
                        completeness.pvt ? 'text-system-green' : 'text-muted-foreground'
                      )}>
                        PVT Analysis
                      </span>
                    </div>
                ...
                <Card className={cn(
                  'transition-all duration-200',
                  completeness.hydraulics ? 'border-system-green/30 bg-system-green/5' : 'border-border/30'
                )}>
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      <div className={cn(
                        'h-3 w-3 rounded-full',
                        completeness.hydraulics ? 'bg-system-green' : 'bg-muted-foreground/30'
                      )} />
                      <span className={cn(
                        'text-sm font-medium',
                        completeness.hydraulics ? 'text-system-green' : 'text-muted-foreground'
                      )}>
                        Hydraulics Analysis
                      </span>
                    </div>
