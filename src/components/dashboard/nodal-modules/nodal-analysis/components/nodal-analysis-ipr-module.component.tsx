      ...
      <div className="relative group">
        ...
        <Input
          ...
          className={cn(
            ...
            hasValue && 'border-system-green/60 bg-system-green/5',
        ...
        {/* Unit indicator for non-floating state */}
        {unit && !shouldShowFloatingLabel && (
...
export const NodalAnalysisIprModule: React.FC = () => {
  ...
  const isReadyForCalculation = (iprInputs.BOPD || 0) > 0 && (iprInputs.Pr || 0) > 0;
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-1">
              ...
              <CardDescription className="text-subheadline text-muted-foreground leading-relaxed">
                Enter your well's flow rates and reservoir parameters. 
                IPR curve will be calculated after completing PVT analysis.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
            ...
            {!completeness.pvt && (
              <Alert className={cn(
                ...
                <AlertDescription className="text-system-orange/90 font-medium">
                  Complete the PVT analysis first to calculate the IPR curve and proceed to the next step.
                </AlertDescription>
              </Alert>
            )}
            ...
            {!isReadyForCalculation && (
              <Alert className={cn(
                ...
                <AlertDescription className="text-system-blue/90 font-medium">
                  Enter valid Oil Rate (BOPD) and Reservoir Pressure (Pr) to enable IPR calculations.
                </AlertDescription>
              </Alert>
            )}
            ...
            {completeness.pvt && completeness.ipr && (
              <Alert className={cn(
                ...
                <AlertDescription className="text-system-green/90 font-medium">
                  IPR calculation complete! You can now proceed to Wellbore Hydraulics analysis.
                </AlertDescription>
              </Alert>
            )}
          </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div className="space-y-1">
                  ...
                  <p className="font-medium text-foreground">
                    {((iprInputs.BOPD || 0) + (iprInputs.BWPD || 0)).toLocaleString()} BPD
                  </p>
                </div>
                <div className="space-y-1">
                  ...
                  <p className="font-medium text-foreground">
                    {iprInputs.BOPD > 0 
                      ? ((iprInputs.MCFD || 0) * 1000 / iprInputs.BOPD).toFixed(0)
                      : '0'
                    } SCF/STB
                  </p>
                </div>
                <div className="space-y-1">
                  ...
                  <p className="font-medium text-foreground">
                    {(iprInputs.BOPD || 0) + (iprInputs.BWPD || 0) > 0
                      ? (((iprInputs.BWPD || 0) / ((iprInputs.BOPD || 0) + (iprInputs.BWPD || 0))) * 100).toFixed(1)
                      : '0'
                    }%
                  </p>
                </div>
                <div className="space-y-1">
                  ...
                  <p className="font-medium text-foreground">
                    {((iprInputs.Pr || 0) - (iprInputs.PIP || 0)).toLocaleString()} psi
                  </p>
                </div>
              </div>
            </div>
